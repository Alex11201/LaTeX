...
\subsection{Прямая Симсона}
    ...
    \end{proof}
    \begin{lemma}
        Пусть $A_0$ и $C_0$ -- произвольные точки на $BC$ и $AB$ треугольника $ABC$ соотвественно. Инцентр $\triangle ABC$ лежит на окружности, описанной около $\triangle A_0BC_0$ тогда и только тогда, когда $AC_0+CA_0=AC$.
    \end{lemma}
    \begin{proof}
        $ $\newline
        \begin{center}
