...
\begin{definition}[Правосторонний предел функции]
	\hfill
	$$A=\lim_{x\to x_0+}f(x)\Longleftrightarrow \forall \varepsilon >0\,\, \exists\, \delta >0:\,\forall x \in (x_0; x_0 + \delta)\Longrightarrow |f(x)-A|<\varepsilon$$
\end{definition}
\begin{definition}[Левосторонний предел функции]
	\hfill
	$$A=\lim_{x\to x_0-}f(x)\Longleftrightarrow \forall \varepsilon >0\,\, \exists\, \delta >0:\,\forall x \in (x_0-\delta; x_0)\Longrightarrow |f(x)-A|<\varepsilon$$
\end{definition}
\begin{definition}
