...
\begin{theorem}[Теорема о трёх синусах]
    Пусть прямая $l$ содержится в одной из граней двугранного угла. Также пусть $\alpha$ – плоский угол данного двугранного, $\beta$ – угол между прямой и ребром двугранного угла, а $\gamma$ – угол между $l$ и её проекцией на вторую грань угла. Тогда:
...
\begin{proof}
    ...
    \fill \point circle (1.8pt);
            ...
            \end{tikzpicture}
    \end{center}
    Пусть $l$ пересекает ребро двугранного угла в точке $O$. Возьмём произвольную точку $A$ на этой прямой. Пусть $C$ – основание перпендикуляра из $A$ на вторую грань двугранного угла. Тогда по теореме о трёх перпендикулярах $CB\perp AB$, а значит $\angle ABC=\alpha$. Тогда:
