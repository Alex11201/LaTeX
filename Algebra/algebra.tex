...
\end{statement}
\begin{definition}
    Пусть $a_n$ ограничена и $\limsup\limits_{n\to\infty}a_n=\liminf\limits_{n\to\infty}a_n$. Тогда $a_n$ сходится и имеет предел:
    $$\lim_{n\to\infty}a_n=\limsup\limits_{n\to\infty}a_n=\liminf\limits_{n\to\infty}a_n$$
\end{definition}
