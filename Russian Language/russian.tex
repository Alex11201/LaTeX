...
%Оглавление
\title{\textbf{Русский язык}}\date{}\author{}
...
\begin{rrule}[Правописание суффиксов -оньк-/-еньк-]
    ...
    \begin{example}
        Мягонький, плохонький, худенький, славненький.
    \end{example}
\end{rrule}
...
\begin{rrule}[Правописание НЕ с наречиями не на -о/-е]
    \hfill
    \begin{enumerate}
        \item НЕ с отрицательными местоимениями пишется слитно.
        \begin{example}
            Н\'{е}когда, н\'{е}где, н\'{е}куда, н\'{е}зачем.
        \end{example}
        \item НЕ с наречиями в сравнительной степени пишется раздельно.
        \begin{example}
            Не медленнее, не быстрее.
        \end{example}
        \item НЕ с наречиями, которые пишутся через дефис, пишется раздельно.
        \begin{example}
            Не по-зимнему, не по-русски.
        \end{example}
    \end{enumerate}
\end{rrule}
...
\begin{rrule}[Правописание НЕ с категорией состояния]
    НЕ с категорией состояния пишется слитно при утверждении и раздельно при отрицании.
    \begin{example}
        \textsl{Неважно}, что он о нас думает; \textsl{не весело} думать, что праздник уже закончился.
    \end{example}
\end{rrule}
...
\begin{rrule}[Правописание наречий]
    \hfill 
    \begin{enumerate}
