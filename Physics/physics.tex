...
\begin{formula}[Формула тонкой линзы]
    ...
    \begin{center}
        \begin{minipage}{12cm}
            $F$ [м] -- фокусное расстояние (берётся положительное, если линза собирающая и отрицательное, если рассеивающая), $f$ [м] -- расстояние от предмета до линзы (берётся положительное, если изображение действительное и отрицательное, если мнимое), $d$ [м] -- расстояние от изображения до линзы.
        \end{minipage}
    \end{center}
\end{formula}
\begin{formula}
    ...
    \begin{center}
        \begin{minipage}{12cm}
            $\Gamma$ -- поперечное увеличение линзы, $f$ [м] –- расстояние от предмета до линзы, $d$ [м] -- расстояние от изображения до линзы.
        \end{minipage}
    \end{center}
\end{formula}
