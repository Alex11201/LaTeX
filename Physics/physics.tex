...
\begin{law}[Закон Кулона]
    $$\vv{F}=k \frac{|q_1|\cdot|q_2|}{\varepsilon\cdot r^2}$$
    \begin{center}
        \begin{minipage}{15cm}
...
\begin{formula}
    ...
    \begin{center}
        \begin{minipage}{12cm}
            $W$ [Дж] -- энергия в электрической цепи, $W_C$ [Дж] -- энергия в конденсаторе, $W_L$ [Дж] -- энергия в катушке индуктивности.
        \end{minipage}
    \end{center}
\end{formula}
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[right, align=left] at (5,0) {
              ...
              $n_1<n_2\Longrightarrow\alpha<\gamma;\,\,n_1>n_2\Longrightarrow\alpha>\gamma$
        };
    \end{tikzpicture}
\end{center}
...
\end{definition}
\begin{formula}
    $$n=\left\lfloor\frac{360^\circ-\alpha}{\alpha}\right\rfloor$$
    \begin{center}
        \begin{minipage}{12cm}
            \centering
...
\begin{formula}[Формула тонкой линзы]
    ...
    \begin{center}
        \begin{minipage}{12cm}
            $F$ [м] -- фокусное расстояние (берётся положительное, если линза собирающая и отрицательное, если рассеивающая), $f$ [м] -- расстояние от изображения до линзы (берётся положительное, если изображение действительное и отрицательное, если мнимое), $d$ [м] -- расстояние от предмета до линзы.
        \end{minipage}
    \end{center}
\end{formula}
\begin{formula}
